(function($) {
    "use strict";
    /* Menu toogle_menu_7_9000 */
    function toogleMenuPro_7_9000() {
        var $ = jQuery;
        var wi = $(window).width();
        var wrapperMenu = $(".wrapper-7_9000");
        var container = $("#toogle_menu_7_9000");
    ...
    /* Menu toogle_menu_9_6192 */
    function toogleMenuPro_9_6192() {
        var $ = jQuery;
        var wi = $(window).width();
        var wrapperMenu = $(".wrapper-9_6192");
        var container = $("#toogle_menu_9_6192");
        if (EM.SETTING.DISABLE_RESPONSIVE != 0) {
            if ((wi <= 767 || isPhone == true)) {
                wrapperMenu.addClass('em-menu-mobile');
            } else {
    ...
    jQuery(document).ready(function() {
        toogleMenuPro_7_9000();
        toogleMenuPro_9_6192();
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_16_16746_sync1');
        sync1.owlCarousel({
            singleItem: true,
