(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_13_13246_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /* New Arrival */
        var owl = $("#em_minifilter_products_8c947c7a463b2595e37aec69702864b8").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_8c947c7a463b2595e37aec69702864b8').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        /* Sale Product */
        var owl = $("#em_minifilter_products_1fddb463e5ba7448f222e22bb28dc653").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_1fddb463e5ba7448f222e22bb28dc653').find('img.em-img-lazy');
                    if ($_img.length) {
                        var timeout = setTimeout(function() {
                            $_img.trigger("appear");
                        }, 200);
