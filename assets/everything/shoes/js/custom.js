(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_3_3518_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /* Featured Slider */
        var owl = $("#em_minifilter_products_f94983558a8793ed9183bc2b53c16079").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_f94983558a8793ed9183bc2b53c16079').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        var $_eheight = $('#em_minifilter_products_f94983558a8793ed9183bc2b53c16079').find('.em-filterproducts-grid');
        setEqualElement($_eheight, '.desc');
        var $_imgThumb = $('#em_minifilter_products_f94983558a8793ed9183bc2b53c16079').find('.em-thumb');
