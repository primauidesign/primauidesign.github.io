(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_5_5277_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /* New Arrival */
        var owl = $("#em_minifilter_products_4b843e1c8f2871f45fc2463e7b7bd194").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_4b843e1c8f2871f45fc2463e7b7bd194').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        /* Best Sales */
        var owl = $("#em_minifilter_products_7433af25a614753e1e7cd2e2eea9a6c8").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_7433af25a614753e1e7cd2e2eea9a6c8').find('img.em-img-lazy');
                    if ($_img.length) {
                        var timeout = setTimeout(function() {
                            $_img.trigger("appear");
                        }, 200);
