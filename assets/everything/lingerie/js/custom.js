(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_10_10579_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /* New Arrival */
        var owl = $("#em_minifilter_products_8df2532942f80f017c272fedf8c1c77c").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_8df2532942f80f017c272fedf8c1c77c').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        /* Best Sales */
        var owl = $("#em_minifilter_products_9a0dda89863b5c5dae6c54c4fd351073").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_9a0dda89863b5c5dae6c54c4fd351073').find('img.em-img-lazy');
                    if ($_img.length) {
                        var timeout = setTimeout(function() {
                            $_img.trigger("appear");
                        }, 200);
