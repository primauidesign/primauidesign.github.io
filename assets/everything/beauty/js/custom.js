(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* New Arrival Tab */
        jQuery('#emtabs_019340eb31b30b8c3b851aa44eff591a').responsiveTabs({
            animation: 'fade',
            ...
            activate: function(event, tab) {
                var id = tab.id + 1;
                var $_img = jQuery('#tab_emtabs_019340eb31b30b8c3b851aa44eff591a_' + id).find('img.em-img-lazy');
                $_img.trigger("appear");
                var $_eheight = jQuery('#tab_emtabs_019340eb31b30b8c3b851aa44eff591a_' + id).find('.em-filterproducts-grid');
