(function($) {
    ...
    function toogleMenuPro_12_736() {
        var $ = jQuery;
        var wi = $(window).width();
        var wrapperMenu = $(".wrapper-12_736");
        var container = $("#toogle_menu_12_736");
        if (EM.SETTING.DISABLE_RESPONSIVE != 0) {
            if ((wi <= 767 || isPhone == true)) {
                wrapperMenu.addClass('em-menu-mobile');
            } else {
    ...
    jQuery(document).ready(function() {
        ...
        toogleMenuPro_12_736();

        /* Main Slider */
        var sync1 = $('#em_owlcarousel_15_15219_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /* New Arrival Tab */
        jQuery('#emtabs_d029ddc76abee3b5bd46c6bb334b05f8').responsiveTabs({
            animation: 'fade',
            ...
            activate: function(event, tab) {
                var id = tab.id + 1;
                var $_img = jQuery('#tab_emtabs_d029ddc76abee3b5bd46c6bb334b05f8_' + id).find('img.em-img-lazy');
                $_img.trigger("appear");
                var $_eheight = jQuery('#tab_emtabs_d029ddc76abee3b5bd46c6bb334b05f8_' + id).find('.em-filterproducts-grid');
                setEqualElement($_eheight, '.product-name');
            },
        });

        /* Tab 1 */
        jQuery(".em_lightbox_em-games-new-arrivals-tab010").fancybox({
            margin: [20, 40, 20, 10],
            scrolling: 'no',
            type: 'image',
            nextEffect: 'none',
        ...
        /* Tab 2 */
        jQuery(".em_lightbox_em-games-new-arrivals-tab020").fancybox({
            margin: [20, 40, 20, 10],
            scrolling: 'no',
            type: 'image',
            nextEffect: 'none',
        ...
        /* Tab 3 */
        jQuery(".em_lightbox_em-games-new-arrivals-tab030").fancybox({
            margin: [20, 40, 20, 10],
            scrolling: 'no',
            type: 'image',
            nextEffect: 'none',
        ...
        /* Tab 4 */
        jQuery(".em_lightbox_em-games-new-arrivals-tab040").fancybox({
            margin: [20, 40, 20, 10],
            scrolling: 'no',
            type: 'image',
            nextEffect: 'none',
        ...
        /* Best Seller */
        var owl = $("#em_minifilter_products_1715fafc6b93825fc90154b48870be51").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_1715fafc6b93825fc90154b48870be51').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        /* Best Sales */
        var $_imgThumb = $('#em_minifilter_products_8cc9b3c6a76046e5a85d64d8042bec5f').find('.em-thumb');
        $_imgThumb.click(function() {
            $(this.hash).attr('src', this.href);
        });
